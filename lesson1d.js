...
console.log("Is James Registered?", isRegistered)
console.log(typeof(isAdult))

//undefined: This is a data type that has been declared but threr is no value that has been assigned to it 
let county;
